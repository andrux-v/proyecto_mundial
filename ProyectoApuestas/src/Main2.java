...
public class Main2 {
    public static void main(String[] args) {
        ...
        // Initialize database (creates schema, tables, pre-seeds admin and 72 matches)
        System.out.println("Inicializando conexion con la base de datos...");
        boolean dbOk = ConexionBD.inicializarBaseDeDatos();
